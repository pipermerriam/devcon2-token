...
let SignatureParametersForm = reduxForm({form: 'proxy-signature-parameters'})(React.createClass({
  render() {
    return (
      <div className="card">
        <div className="card-header">
          <em>Step 1</em>: Signature Parameters
        </div>
        <div className="card-block">
          <form className="container clearfix" onSubmit={this.props.handleSubmit}>
            ...
            <p className="text-xs-right"><button type="submit" className="btn btn-primary">Next</button></p>
          </form>
        </div>
      </div>
    )
      ...
      <div className="card">
        ...
        <div className="card-block">
          ...
          <form onSubmit={this.props.handleSubmit}>
            ...
            <button className="btn btn-primary" type="submit">Save Signature</button>
          </form>
        </div>
      </div>
    )
